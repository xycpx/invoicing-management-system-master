    ...
    <div class="layuimini-main">
        ...
        <div class="layui-form layuimini-form">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="password" name="again_password" lay-verify="required" lay-reqtext="新的密码不能为空" placeholder="确认密码"  value="" class="layui-input">
                </div>
            </div>
...
<script type="text/javascript" src="${ctx.contextPath}/js/user/password.js"></script>
